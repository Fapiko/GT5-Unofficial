...
public class GT_Block_Machines
    ...
    public void breakBlock(World aWorld, int aX, int aY, int aZ, Block par5, int par6) {
        ...
        if ((tTileEntity instanceof IGregTechTileEntity)) {
            ...
            //Dont drop if it is a quantum chest - to prevent portability dupe
            if(!tGregTechTileEntity.getMetaTileEntity().getBaseMetaTileEntity().isDigitalChest())
                for (int i = 0; i < tGregTechTileEntity.getSizeInventory(); i++) {
                    ...
                    if ((tItem != null) && (tItem.stackSize > 0) && (tGregTechTileEntity.isValidSlot(i))) {
                        ...
                        tItemEntity.motionX = (tRandom.nextGaussian() * 0.05D);
                        tItemEntity.motionY = (tRandom.nextGaussian() * 0.05D + 0.2D);
                        tItemEntity.motionZ = (tRandom.nextGaussian() * 0.05D);
